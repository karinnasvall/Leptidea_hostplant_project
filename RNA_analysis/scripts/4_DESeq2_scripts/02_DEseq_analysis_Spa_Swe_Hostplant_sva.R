...
# standard filtering
OUT_FOLD_STDF <- "/crex1/proj/uppstore2017185/b2014034_nobackup/Veronika/RNA_HostPlantProject/results/4_DESeq2/04_SpaSwe_Hostplant_effect/"
...
Instar3_coldata <- Instar3_coldata[ , 1:4]
Instar5M_coldata <- Instar5M_coldata[ , 1:4]
Instar5F_coldata <- Instar5F_coldata[ , 1:4]
...
ddsInstar3_SpaSwe_Host <- DESeqDataSetFromMatrix(countData = Instar3_countdata,
                                    colData = Instar3_coldata, design = ~Hostplant)
ddsInstar3_SpaSwe_Host

ddsInstar5M_SpaSwe_Host <- DESeqDataSetFromMatrix(countData = Instar5M_countdata,
                                  colData = Instar5M_coldata, design = ~Hostplant)
ddsInstar5M_SpaSwe_Host

ddsInstar5F_SpaSwe_Host <- DESeqDataSetFromMatrix(countData = Instar5F_countdata,
                                   colData = Instar5F_coldata, design = ~Hostplant)
ddsInstar5F_SpaSwe_Host
...
ddsInstar3_SpaSwe_Host <- ddsInstar3_SpaSwe_Host[rowMeans(counts(ddsInstar3_SpaSwe_Host)) > 2, ]
ddsInstar3_SpaSwe_Host
ddsInstar5M_SpaSwe_Host <- ddsInstar5M_SpaSwe_Host[rowMeans(counts(ddsInstar5M_SpaSwe_Host)) > 2, ]
ddsInstar5M_SpaSwe_Host
ddsInstar5F_SpaSwe_Host <- ddsInstar5F_SpaSwe_Host[rowMeans(counts(ddsInstar5F_SpaSwe_Host)) > 2, ]
ddsInstar5F_SpaSwe_Host
...
ddsInstar3_SpaSwe_Host <- DESeq(ddsInstar3_SpaSwe_Host)
res_Instar3_SpaSwe_Host <- results(ddsInstar3_SpaSwe_Host, alpha=.05)
res_Instar3_SpaSwe_Host

ddsInstar5M_SpaSwe_Host <- DESeq(ddsInstar5M_SpaSwe_Host)
res_Instar5M_SpaSwe_Host <- results(ddsInstar5M_SpaSwe_Host, alpha=.05)
res_Instar5M_SpaSwe_Host

ddsInstar5F_SpaSwe_Host <- DESeq(ddsInstar5F_SpaSwe_Host)
res_Instar5F_SpaSwe_Host <- results(ddsInstar5F_SpaSwe_Host, alpha=.05)
res_Instar5F_SpaSwe_Host
...
#Filter baseMean > 10 ####
Filtered_base_Mean_10_Instar3_SpaSwe_Host <- subset(res_Instar3_SpaSwe_Host, baseMean>10)
Filtered_base_Mean_10_Instar5M_SpaSwe_Host <- subset(res_Instar5M_SpaSwe_Host, baseMean>10)
Filtered_base_Mean_10_Instar5F_SpaSwe_Host <- subset(res_Instar5F_SpaSwe_Host, baseMean>10)

summary(Filtered_base_Mean_10_Instar3_SpaSwe_Host)
summary(Filtered_base_Mean_10_Instar5M_SpaSwe_Host)
summary(Filtered_base_Mean_10_Instar5F_SpaSwe_Host)


# Filter logFC > |1.0|) ####
Filtered_base_Mean_10_LFC_1.0_Instar3_SpaSwe_Host <- subset(Filtered_base_Mean_10_Instar3_SpaSwe_Host, log2FoldChange >1 | log2FoldChange < -1)
Filtered_base_Mean_10_LFC_1.0_Instar5M_SpaSwe_Host <- subset(Filtered_base_Mean_10_Instar5M_SpaSwe_Host, log2FoldChange >1 | log2FoldChange < -1)
Filtered_base_Mean_10_LFC_1.0_Instar5F_SpaSwe_Host <- subset(Filtered_base_Mean_10_Instar5F_SpaSwe_Host, log2FoldChange >1 | log2FoldChange < -1)

summary(Filtered_base_Mean_10_LFC_1.0_Instar3_SpaSwe_Host)
summary(Filtered_base_Mean_10_LFC_1.0_Instar5M_SpaSwe_Host)
summary(Filtered_base_Mean_10_LFC_1.0_Instar5F_SpaSwe_Host)


## Filter p-adj < 0.05 (no batch effects correction)
Filtered_base_Mean_10_LFC_1.0_P0.05_Instar3_SpaSwe_Host <- subset(Filtered_base_Mean_10_LFC_1.0_Instar3_SpaSwe_Host, padj<0.05)
Filtered_base_Mean_10_LFC_1.0_P0.05_Instar5M_SpaSwe_Host <- subset(Filtered_base_Mean_10_LFC_1.0_Instar5M_SpaSwe_Host, padj<0.05)
Filtered_base_Mean_10_LFC_1.0_P0.05_Instar5F_SpaSwe_Host <- subset(Filtered_base_Mean_10_LFC_1.0_Instar5F_SpaSwe_Host, padj<0.05)

summary(Filtered_base_Mean_10_LFC_1.0_P0.05_Instar3_SpaSwe_Host)
summary(Filtered_base_Mean_10_LFC_1.0_P0.05_Instar5M_SpaSwe_Host)
summary(Filtered_base_Mean_10_LFC_1.0_P0.05_Instar5F_SpaSwe_Host)
...
#unfiltered
write.table(res_Instar3_SpaSwe_Host,
          file = "res_Instar3_SpaSwe_Host.txt", sep = "\t", quote = FALSE)
write.table(res_Instar5M_SpaSwe_Host, 
          file = "res_Instar5M_SpaSwe_Host.txt", sep = "\t", quote = FALSE)
write.table(res_Instar5F_SpaSwe_Host, 
          file = "res_Instar5F_SpaSwe_Host.txt", sep = "\t", quote = FALSE)


#filtered baseMean |1|
write.table(Filtered_base_Mean_10_Instar3_SpaSwe_Host, 
            file = "Filtered_base_Mean_10_Instar3_SpaSwe_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_base_Mean_10_Instar5M_SpaSwe_Host, 
            file = "Filtered_base_Mean_10_Instar5M_SpaSwe_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_base_Mean_10_Instar5F_SpaSwe_Host, 
            file = "Filtered_base_Mean_10_Instar5F_SpaSwe_Host.txt", sep = "\t", quote = FALSE)


#filtered LFC |1|
write.table(Filtered_base_Mean_10_LFC_1.0_Instar3_SpaSwe_Host, 
          file = "Filtered_base_Mean_10_LFC_1.0_Instar3_SpaSwe_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_base_Mean_10_LFC_1.0_Instar5M_SpaSwe_Host, 
          file = "Filtered_base_Mean_10_LFC_1.0_Instar5M_SpaSwe_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_base_Mean_10_LFC_1.0_Instar5F_SpaSwe_Host, 
          file = "Filtered_base_Mean_10_LFC_1.0_Instar5F_SpaSwe_Host.txt", sep = "\t", quote = FALSE)



#filtered p<0.05
write.table(Filtered_base_Mean_10_LFC_1.0_P0.05_Instar3_SpaSwe_Host, 
          file = "Filtered_base_Mean_10_LFC_1.0_P0.05_Instar3_SpaSwe_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_base_Mean_10_LFC_1.0_P0.05_Instar5M_SpaSwe_Host, 
          file = "Filtered_base_Mean_10_LFC_1.0_P0.05_Instar5M_SpaSwe_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_base_Mean_10_LFC_1.0_P0.05_Instar5F_SpaSwe_Host, 
          file = "Filtered_base_Mean_10_LFC_1.0_P0.05_Instar5F_SpaSwe_Host.txt", sep = "\t", quote = FALSE)
...
EnhancedVolcano(Filtered_base_Mean_10_Instar3_SpaSwe_Host,
                lab = rownames(Filtered_base_Mean_10_Instar3_SpaSwe_Host),
                x = 'log2FoldChange',
                y = 'pvalue',
                xlim = c(-8, 8),
                title = 'Filtered_base_Mean_10_Instar3_SpaSwe_Host',
                pCutoff = 10e-16,
                FCcutoff = 1.0,
...
EnhancedVolcano(Filtered_base_Mean_10_Instar5F_SpaSwe_Host,
                lab = rownames(Filtered_base_Mean_10_Instar5F_SpaSwe_Host),
                x = 'log2FoldChange',
                y = 'padj',
                xlim=c(-10,10),
                xlab = bquote(~Log[2]~ 'fold change'),
                ylab = bquote(~-Log[10]~adjusted~italic(P)),
                title = 'SpaSwe_Instar5F',
                pCutoff = 0.05,
                FCcutoff = 1.0,
                transcriptLabSize = 0,
