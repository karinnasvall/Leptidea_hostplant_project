...
colnames(colData) <- c("Hostplant", "Population", "Stage")
colData
...
# standard filtering
OUT_FOLD_STDF <- "/crex1/proj/uppstore2017185/b2014034_nobackup/Veronika/RNA_HostPlantProject/results/4_DESeq2/"
...
ddsInstar3_0 <- DESeq(ddsInstar3)
res_Instar3_0 <- results(ddsInstar3_0, alpha=.05)
res_Instar3_0

ddsInstar5M_0 <- DESeq(ddsInstar5M)
res_Instar5M_0 <- results(ddsInstar5M_0, alpha=.05)
res_Instar5M_0

ddsInstar5F_0 <- DESeq(ddsInstar5F)
res_Instar5F_0 <- results(ddsInstar5F_0, alpha=.05)
res_Instar5F_0
...
Filtered_P0.05_Instar3_0 <- subset(res_Instar3_0, padj<0.05)
Filtered_P0.05_Instar5M_0 <- subset(res_Instar5M_0, padj<0.05)
Filtered_P0.05_Instar5F_0 <- subset(res_Instar5F_0, padj<0.05)

summary(Filtered_P0.05_Instar3_0)
summary(Filtered_P0.05_Instar5M_0)
summary(Filtered_P0.05_Instar5F_0)
...
# Filter logFC > |1.0|) ####
Filtered_P0.05_LFC_1.5_Instar3_0 <- subset(Filtered_P0.05_Instar3_0, log2FoldChange >1 | log2FoldChange < -1)
Filtered_P0.05_LFC_1.5_Instar5M_0 <- subset(Filtered_P0.05_Instar5M_0, log2FoldChange >1 | log2FoldChange < -1)
Filtered_P0.05_LFC_1.5_Instar5F_0 <- subset(Filtered_P0.05_Instar5F_0, log2FoldChange >1 | log2FoldChange < -1)
...
#unfiltered
write.table(res_Instar3_0,
          file = "res_Instar3_0.txt", sep = "\t", quote = FALSE)
write.table(res_Instar5M_0, 
          file = "res_Instar5M_0.txt", sep = "\t", quote = FALSE)
write.table(res_Instar5F_0, 
          file = "res_Instar5F_0.txt", sep = "\t", quote = FALSE)

#filtered p<0.05
write.table(Filtered_P0.05_Instar3_0, 
          file = "Filtered_P0.05_Instar3_0.txt", sep = "\t", quote = FALSE)
write.table(Filtered_P0.05_Instar5M_0, 
          file = "Filtered_P0.05_Instar5M_0.txt", sep = "\t", quote = FALSE)
write.table(Filtered_P0.05_Instar5F_0, 
          file = "Filtered_P0.05_Instar5F_0.txt", sep = "\t", quote = FALSE)

#filtered LFC |1|
write.table(Filtered_P0.05_LFC_1.5_Instar3_0, 
          file = "Filtered_P0.05_LFC_1.5_Instar3_0.txt", sep = "\t", quote = FALSE)
write.table(Filtered_P0.05_LFC_1.5_Instar5M_0, 
          file = "Filtered_P0.05_LFC_1.5_Instar5M_0.txt", sep = "\t", quote = FALSE)
write.table(Filtered_P0.05_LFC_1.5_Instar5F_0, 
          file = "Filtered_P0.05_LFC_1.5_Instar5F_0.txt", sep = "\t", quote = FALSE)
