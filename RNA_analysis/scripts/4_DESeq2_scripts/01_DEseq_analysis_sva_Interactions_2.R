...
setwd("/proj/uppstore2017185/b2014034_nobackup/Veronika/RNA_HostPlantProject/results/4_DESeq2/03_Interaction_effect")
...
Instar3_coldata <- Instar3_coldata[ , 1:3]
Instar5M_coldata <- Instar5M_coldata[ , 1:3]
Instar5F_coldata <- Instar5F_coldata[ , 1:3]
...
ddsInstar3_Pop_Host <- DESeqDataSetFromMatrix(countData = Instar3_countdata,
                                    colData = Instar3_coldata, design = ~Population+Hostplant+Population:Hostplant)
ddsInstar3_Pop_Host

ddsInstar5M_Pop_Host <- DESeqDataSetFromMatrix(countData = Instar5M_countdata,
                                  colData = Instar5M_coldata, design = ~Population+Hostplant+Population:Hostplant)
ddsInstar5M_Pop_Host

ddsInstar5F_Pop_Host <- DESeqDataSetFromMatrix(countData = Instar5F_countdata,
                                   colData = Instar5F_coldata, design = ~Population+Hostplant+Population:Hostplant)
...
res_Instar3_Pop_Host
resultsNames(ddsInstar3_Pop_Host)
res_Instar3_contr1_Pop_Host <- results(ddsInstar3_Pop_Host, alpha=.05, contrast = c("Hostplant", "Lot", "Dor"))
summary(res_Instar3_contr1_Pop_Host)
res_Instar3_contr1_Pop_Host_pop <- results(ddsInstar3_Pop_Host, alpha=.05, list(c("Hostplant_Lot_vs_Dor", "Populationswe.HostplantLot")))
summary(res_Instar3_contr1_Pop_Host_pop)
results(ddsInstar3_Pop_Host, name="Populationswe.HostplantLot")

ddsInstar5M_Pop_Host <- DESeq(ddsInstar5M_Pop_Host)
res_Instar5M_Pop_Host <- results(ddsInstar5M_Pop_Host, alpha=.05)
res_Instar5M_Pop_Host

ddsInstar5F_Pop_Host <- DESeq(ddsInstar5F_Pop_Host)
res_Instar5F_Pop_Host <- results(ddsInstar5F_Pop_Host, alpha=.05)
res_Instar5F_Pop_Host
...
Filtered_P0.05_Instar3_Pop_Host <- subset(res_Instar3_Pop_Host, padj<0.05)
Filtered_P0.05_Instar5M_Pop_Host <- subset(res_Instar5M_Pop_Host, padj<0.05)
Filtered_P0.05_Instar5F_Pop_Host <- subset(res_Instar5F_Pop_Host, padj<0.05)

summary(Filtered_P0.05_Instar3_Pop_Host)
summary(Filtered_P0.05_Instar5M_Pop_Host)
summary(Filtered_P0.05_Instar5F_Pop_Host)
...
# Filter logFC > |1.0|) ####
Filtered_P0.05_LFC_1.5_Instar3_Pop_Host <- subset(Filtered_P0.05_Instar3_Pop_Host, log2FoldChange >1 | log2FoldChange < -1)
Filtered_P0.05_LFC_1.5_Instar5M_Pop_Host <- subset(Filtered_P0.05_Instar5M_Pop_Host, log2FoldChange >1 | log2FoldChange < -1)
Filtered_P0.05_LFC_1.5_Instar5F_Pop_Host <- subset(Filtered_P0.05_Instar5F_Pop_Host, log2FoldChange >1 | log2FoldChange < -1)

summary(Filtered_P0.05_LFC_1.5_Instar3_Pop_Host)
summary(Filtered_P0.05_LFC_1.5_Instar5M_Pop_Host)
summary(Filtered_P0.05_LFC_1.5_Instar5F_Pop_Host)
...
#unfiltered
write.table(res_Instar3_Pop_Host,
          file = "res_Instar3_Pop_Host.txt", sep = "\t", quote = FALSE)
write.table(res_Instar5M_Pop_Host, 
          file = "res_Instar5M_Pop_Host.txt", sep = "\t", quote = FALSE)
write.table(res_Instar5F_Pop_Host, 
          file = "res_Instar5F_Pop_Host.txt", sep = "\t", quote = FALSE)

#filtered p<0.05
write.table(Filtered_P0.05_Instar3_Pop_Host, 
          file = "Filtered_P0.05_Instar3_Pop_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_P0.05_Instar5M_Pop_Host, 
          file = "Filtered_P0.05_Instar5M_Pop_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_P0.05_Instar5F_Pop_Host, 
          file = "Filtered_P0.05_Instar5F_Pop_Host.txt", sep = "\t", quote = FALSE)

#filtered LFC |1|
write.table(Filtered_P0.05_LFC_1.5_Instar3_Pop_Host, 
          file = "Filtered_P0.05_LFC_1.5_Instar3_Pop_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_P0.05_LFC_1.5_Instar5M_Pop_Host, 
          file = "Filtered_P0.05_LFC_1.5_Instar5M_Pop_Host.txt", sep = "\t", quote = FALSE)
write.table(Filtered_P0.05_LFC_1.5_Instar5F_Pop_Host, 
          file = "Filtered_P0.05_LFC_1.5_Instar5F_Pop_Host.txt", sep = "\t", quote = FALSE)
